        ...
        <section className="grid gap-6 lg:grid-cols-2">
            ...
            <SensorChart
              ...
              lines={[
                leftSensorMeta && {
                  ...
                  stroke:
                    leftSensorMeta.key === "temperature"
                      ? "#e63946"
                      : leftSensorMeta.key === "humidity"
                      ? "#457b9d"
                      : leftSensorMeta.key === "airQuality"
                      ? "#2a9d8f"
                      : leftSensorMeta.key === "co2"
                      ? "#8e44ad"
                      : leftSensorMeta.key === "luminosity"
                      ? "#f4a261"
                      : leftSensorMeta.key === "uvIndex"
                      ? "#e9c46a"
                      : "#333",
                },
                rightSensorMeta && {
                  ...
                  stroke:
                    rightSensorMeta.key === "temperature"
                      ? "#e63946"
                      : rightSensorMeta.key === "humidity"
                      ? "#457b9d"
                      : rightSensorMeta.key === "airQuality"
                      ? "#2a9d8f"
                      : rightSensorMeta.key === "co2"
                      ? "#8e44ad"
                      : rightSensorMeta.key === "luminosity"
                      ? "#f4a261"
                      : rightSensorMeta.key === "uvIndex"
                      ? "#e9c46a"
                      : "#555",
                },
              ].filter(Boolean)}
          ...
          >
            ...
            <SensorChart
              data={filtered}
              lines={[
                { key: "co2", name: "CO₂ (ppm)", stroke: "#8e44ad" },
                { key: "luminosity", name: "Luminosity (lx)", stroke: "#f4a261" },
              ]}
            />
          </motion.div>
        </section>
        ...
        >
          ...
          {predictionSeries.length ? (
            <SensorChart
              ...
              lines={[
                { key: "actual", name: "Actual", stroke: "#2a9d8f" },
                { key: "predicted", name: "Predicted", stroke: "#e9c46a", strokeDasharray: "5 5"  },
                {
                  key: "error",
